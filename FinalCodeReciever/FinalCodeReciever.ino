...
void ManualControl() {
  ...
  while (RecievedButtons[0] == 1) { leftGroup.moveServos(1);  rightGroup.moveServos(1);  }
  while (RecievedButtons[1] == 1) { leftGroup.moveServos(-1); rightGroup.moveServos(-1);  }
  while (RecievedButtons[2] == 1) { leftGroup.moveServos(1);  rightGroup.moveServos(-1);  }
  while (RecievedButtons[3] == 1) { leftGroup.moveServos(-1); rightGroup.moveServos(1);  }
